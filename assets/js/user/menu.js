...
function getFilteredAndSortedItems() {
    ...
    // PERBAIKAN BUG: Logika untuk menggabungkan semua menu jika kategori adalah "all"
...
function changeCategory(btn, category) {
    ...
    // Pengecekan aman agar tidak error jika fungsi showSkeletonLoading belum ter-load/tidak ada
